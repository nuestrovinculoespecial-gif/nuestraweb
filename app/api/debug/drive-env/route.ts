...
export async function GET(req: Request) {
  ...
  return Response.json({
    stamp: {
      ...
      GOOGLE_OAUTH_CLIENT_ID: envInfo("GOOGLE_OAUTH_CLIENT_ID"),
     GOOGLE_OAUTH_CLIENT_SECRET: envInfo("GOOGLE_OAUTH_CLIENT_SECRET"),
     GOOGLE_OAUTH_REFRESH_TOKEN: envInfo("GOOGLE_OAUTH_REFRESH_TOKEN"),
  });
}
